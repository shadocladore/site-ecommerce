	...
	<body>
		<div id="header">
			<div class="slogan">
				...
				<?php 
					$reponse = mysqli_query($db, "SELECT COUNT(*) AS numrows FROM pannier, produit 
					WHERE pannier.id_client = '".$_SESSION['id_client']."' and 
					pannier.id_produit = produit.id_produit") or die("Echec de l'exécution de la requete");
					$pannier = mysqli_fetch_array($reponse);
					$nbr_produit = $pannier['numrows'];
					...
					if($client['photo_client'] == "") {
						$nom_photo = "../clients/personne.png";
					} else {
				...
				<div class="compte">
					...
					<em><?php echo @$nbr_produit; ?></em>
					<a href="pannier.php"><img src="images/cart_menu.png" width="23" height="27" id="cart" title="votre pannier"/></a>
					<a href="#"><img id="profil" src="images/clients/<?php echo $nom_photo; ?>" width="20" height="20"/><i id="en_ligne"><img id="icone_ligne" src="images/ligne.png" width="10" height="10" alt=""/></i></a>
					</div>
		...
		<div id="bloc_profil">
			<img src="images/haut.png" class="direction" width="25" height="17" />
			<div class="profil">
				<img src="images/close.png" id="close" width="18" height="18" />
				<img class="img_prof" src="images/clients/<?php echo $nom_photo; ?>" width="20" height="20" />
			</div>	
			<div class="parametres">
				<p>
					<a href="modifier_profil.php"> Mon profil </a> <a href="deconnexion.php" id="deconnexion"> Déconnexion </a>
				</p>
			</div>
		</div>
...
aide.onclick = function() {
	...
	// Masquer et aficher le bloc profil
var profil = document.getElementById('profil');
var bloc_profil = document.getElementById('bloc_profil');
profil.onclick = function() {
	if(bloc_profil.style.marginTop=="0px") {
        bloc_profil.style.marginTop="-1000px";
    } else {
        bloc_profil.style.marginTop="0px";
    }
}
...
deconnexion.onclick = function() {
	var c = confirm("Confirmez-vous votre deconnexion ?");
	return c;
}

// Masquer et afficher le menu categprie 
