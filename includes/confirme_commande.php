...
<?php include("includes/entete_connecter.php"); ?>
	<div id="bloc_commande">
		<h6>Résultats de la Commande</h6>
		<h3 class="first"><img class='icone_home' src='images/time2.png' width='27' height='27'/> Commande traitée à <?php echo $date; ?></h3>
...
<?php
	...
	{
		echo"<tr>
				<td width='5%' height="50"><img src='images/produits/".$pannier['photo']."' width=100% height=100% /></td>
				<td width='10%'>".$pannier['nom_produit']."</td><td>".$pannier['prix']."F</td>
				<td width='3%'>".$pannier['quantite_produit']."</td><td>".$pannier['montant_total']."F</td>
			<tr/>";
...
?>
		...
		<p>
			...
			M/Mme <?php echo $_SESSION['nom']; ?> nous vous remerçions d'avoir passer votre Commande et nous vous conctacterons pour une livraison 
			à domicile au plutard dans les 24heures qui suivent.
		</p>
		<h3>Veuillez Cliquer sur "finaliser la commande" afin que votre commande soit prise en compte</h3><br/>
		<p class="confirm"><a href="confirme_commande_ok.php" class='bouton_valider'><img class='icone_valider' src='images/valider.png' width='23' height='23'/> Finaliser la commande&nbsp;</a></p>
	</div>
